...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-red-300">
            <div class="my-10 bg-orange-300 rounded-md pt-6 py-6 w-fit mx-auto shadow-lg">
            ...
            <div class=" bg-white shadow-md overflow-hidden sm:rounded-lg">
                ...
                <div class="mt-10 bg-orange-300 rounded-md pt-6 py-6 w-fit mx-auto">
                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex ">
                    <a href="{{ route('pesanan.dine_in') }}" class="mx-5 my-10 w-60 py-16 bg-orange-300 border border-gray-200 rounded-lg shadow hover:bg-orange-200 ">
                    ...
                    <a href="{{ route('pesanan.take_away') }}" class="mx-5 my-10 w-60 py-16 bg-orange-300 border border-gray-200 rounded-lg shadow hover:bg-orange-200 ">
